    ...
    public class SmtpClientCustom
    {
        ...
        public bool Connect()
        {
            ...
            if (!string.IsNullOrEmpty(LogFile))
                LogString("\r\n*** Starting SMTP connection - " + DateTime.UtcNow.ToString());
        ...
        {
            if (!string.IsNullOrEmpty(LogFile))
                LogString("\r\n*** Starting SMTP Send Operation - " + DateTime.UtcNow.ToString());
            ...
            Send("Date: " + TimeUtils.MimeDateTime(DateTime.UtcNow) + "\r\n");
        ...
        void Close()
        {
            ...
            if (!string.IsNullOrEmpty(LogFile))
                LogString("*** SMTP Connection closed: " + DateTime.UtcNow.ToString());
        }
