...
using Eagle.Core.HtmlHelper.CheckBox.Internal;
...
namespace Eagle.Core.HtmlHelper.CheckBox
{
    ...
    internal class ListBuilder : BuilderBase
    {
        ...
        private StringBuilder _createCheckBoxListElement
          (StringBuilder sb, System.Web.Mvc.HtmlHelper htmlHelper, ModelMetadata modelMetadata,
          ...
          string itemText, TextLayout textLayout)
        {
            ...
            if (htmlHelper.ViewData.ModelState.TryGetValue(fullName, out modelState))
                if (modelState.Errors.Count > 0)
                    checkbox_builder.AddCssClass(System.Web.WebPages.Html.HtmlHelper.ValidationInputCssClassName);
