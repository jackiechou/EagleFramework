...
{
    /// <summary>
    /// Model => IPagedList<Customer> => ToPagedList(page, 10, "CustomerID", sort);
    /// @Html.GridView<Customer>(Model, new string[] { "CustomerID", "CompanyName" }, new GridViewOption() )
    /// </summary>
    public static class GridViewHelper
    {
        public static string GridView<T>(this System.Web.Mvc.HtmlHelper helper)
        {
            return GridView<T>(helper, null, null, new DataGridOption());
        }
        public static string GridView<T>(this System.Web.Mvc.HtmlHelper helper, object data)
        {
            return GridView<T>(helper, data, null, new DataGridOption());
        }
        public static string GridView<T>(this System.Web.Mvc.HtmlHelper helper, object data, string[] columns, DataGridOption options)
        {
            // Get items  
