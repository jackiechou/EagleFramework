...
{
    public class AttributeOptionRepository : RepositoryBase<AttributeOption>, IAttributeOptionRepository
    {
        public AttributeOptionRepository(IDataContext dataContext) : base(dataContext) { }
        public IEnumerable<AttributeOption> GetAttributeOptions(int attributeId)
        {
            return (from o in DataContext.Get<AttributeOption>()
