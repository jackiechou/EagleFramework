...
namespace Eagle.Repositories
{
    ...
    {
        SelectList GeneratePeriod(string optionText = null, bool? isShowSelectText = true);
        ...
        SelectList GetMonths(string languageCode, string selectedValue, bool? isShowSelectText = false);
