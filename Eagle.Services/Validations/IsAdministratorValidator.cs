...
{
    public class IsAdministratorValidator<TData> : SpecificationBase<TData>
    {
        private static IUnitOfWork UnitOfWork { get; set; }
        private string UserId { get; set; }
        private PermissionLevel PermissionLevel { get; set; }

        public IsAdministratorValidator(IUnitOfWork unitOfWork, string userId, PermissionLevel permissionLevel)
        {
