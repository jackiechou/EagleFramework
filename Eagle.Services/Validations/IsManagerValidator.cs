...
{
    public class IsManagerValidator<TData> : SpecificationBase<TData>
    {
        private static IUnitOfWork UnitOfWork { get; set; }
        private string UserId  { get; set; }
        private PermissionLevel PermissionLevel { get; set; }

        public IsManagerValidator(IUnitOfWork unitOfWork, string userId, PermissionLevel permissionLevel)
        {
