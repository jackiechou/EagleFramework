...
namespace Eagle.WebApp.Areas.Admin.Controllers.Business.Ecommerce
{
    public class ProductAttributeController : BaseController
    {
        ...
        public ProductAttributeController(IProductService productService) : base(new IBaseService[] { productService })
        {
            ProductService = productService;
        }
        //
        // DELETE: /Admin/ProductAttribute/Delete/5
        [HttpDelete]
        public ActionResult Delete(int id)
        {
            try
            {
                ProductService.UpdateProductAttributeStatus(id, ProductAttributeStatus.InActive);
