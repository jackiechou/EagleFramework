(function ($) {
    ...
    function resetControls() {
        var validateObj = $('#frmBannerPosition');
    ...
    function reloadGrid() {
        $.ajax({
            type: "GET",
            url: window.BannerPositionListUrl,
            success: function (data) {
                $('#divList').html(data);
            }
        });
    ...
    function create(url) {
        $.ajax({
            type: "POST",
            url: url,
            data: $("#frmBannerPosition").serialize(),
    ...
    function edit(url) {
        //var data = $("#frmBannerPosition").serialize();
        //$.param($.extend(data, { __RequestVerificationToken: $('input[name="__RequestVerificationToken"]').val() }));

        var formData = $("#frmBannerPosition").serialize();
    ...
    $(document).on("click", ".create", function (e) {
        ...
        if (!$("#frmBannerPosition").valid()) { // Not Valid
            return false;
        } else {
            create(url);
            return false;
