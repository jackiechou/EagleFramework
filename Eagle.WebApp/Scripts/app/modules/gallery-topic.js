(function ($) {
    ...
    function createTree(data) {
        var selectedValue = $('#ParentId').val();
        var $tree = $("#tree");
        $tree.tree({
            lines: true,
            animate: true,
    ...
    function loadTree() {
        ...
        $.ajax({
            type: "GET",
            url: window.GetGalleryTopicTreeGridUrl,
    ...
    function createJsTreeGrid(data) {
        $('#jstreeGrid').jstree({
            ...
            {
                columns: [
                    { header: 'TopicName', width: 424, value: 'text' },
    ...
    function getDetails(id) {
        ...
        $.ajax({
            type: "GET",
            url: window.EditGalleryTopicUrl,
            data: params,
            success: function (data) {
                $('#divEdit').html(data);
                loadTree();
    ...
    function addData() {
        ...
        $.ajax({
            type: "POST",
            url: window.CreateGalleryTopicUrl,
            data: formData,
    ...
    function deleteData(id) {
        ...
        $.ajax({
            type: "DELETE",
            url: window.DeleteGalleryTopicUrl,
            data: params,
            success: function (response, textStatus, jqXhr) {
                if (response.Status === 0) {
                    loadTree();
