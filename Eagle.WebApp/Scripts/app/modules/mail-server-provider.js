(function ($) {
    ...
    function search() {
        var formUrl = window.MailServerProviderListhUrl;
    ...
    function changeSslStatus(url, id, status) {
    ...
    function changeTlsStatus(url, id, status) {
        var params = { "id": id, "status": status };
    ...
    $(document).on("change", ".changeSslStatus", function (e) {
        e.preventDefault();
    ...
    $(document).on("click", ".changeTlsStatus", function (e) {
          e.preventDefault();
