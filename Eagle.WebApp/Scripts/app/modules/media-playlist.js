(function ($) {
    ...
    //Create topic tree -Topic ComboTree
    function populateTopicComboTree(cbxTreeId) {
        var select = $("#" + cbxTreeId);
        var url = select.data('url');
        var selectedValue = select.val();
        var cbxTypeId = cbxTreeId.replace('Topic', 'Type')
        var typeId = $("#" + cbxTypeId).val();
    ...
    function populateTypeSelectBox(selectBoxId) {
        ...
        var url = select.data('url');
        var params = { "selectedId": "", "isShowSelectText": true };
    ...
    $(document).on("change click", "#TypeId", function () {
      //  e.preventDefault();
        var selectedValue = $(this).find(":selected").val();
        $(this).find('option').removeAttr('selected').filter('[value=' + selectedValue + ']').attr('selected', true);
    ...
    function search() {
        var formUrl = window.MediaPlayListSearchUrl;
    ...
    function reloadGrid() {
        $.ajax({
            type: "GET",
            url: window.MediaPlayListSearchUrl,
            success: function (data) {
                $('#divList').html(data);
            }
        });
