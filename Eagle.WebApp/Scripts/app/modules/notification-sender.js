(function ($) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('.email').keyup(function () {
                    ...
                    if (isEmail) { input.removeClass("invalid").removeClass("error").addClass("valid"); }
    ...
    function search() {
        var formUrl = window.NotificationSenderSearchUrl;
    ...
    function updateSelectedItem(url, id) {
        var params = { "id": id };
