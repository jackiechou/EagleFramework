(function ($) {
    ...
    function search() {
        var formUrl = window.ApplicationSettingListUrl;
        ...
        $.ajax({
            ...
            error: function (jqXhr, textStatus, errorThrown) {
                $('#divList').html('<span>' + textStatus + ", " + errorThrown + '</span>');
            }
        });
        return false;
    }
    ...
    function updateSecure(url, id, isSecured) {
    ...
    $(document).on("change", ".changeSecure", function (e) {
        e.preventDefault();
