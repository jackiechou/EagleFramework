...
<script runat="server">
	...
	public override void SetConfig()
	{
		...
		//BaseUrl = "/ckfinder/userfiles/";
                BaseUrl = HttpContext.Current.Request.Url.Scheme + "://" + HttpContext.Current.Request.Url.Authority + HttpContext.Current.Request.ApplicationPath + "uploads/";
                string waterImageUrl = HttpContext.Current.Request.Url.Scheme + "://" + HttpContext.Current.Request.Url.Authority + HttpContext.Current.Request.ApplicationPath + "/Scripts/ckeditor/ckfinder/plugins/watermark/";
