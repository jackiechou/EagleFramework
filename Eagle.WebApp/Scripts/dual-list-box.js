...
(function($) {
    ...
    /** Retrieves all the option elements through a JSON request. */ /** Adds the event listeners to the buttons and filters. */ /** Constructs the jQuery plugin after the elements have been retrieved. */ /** Counts the elements per list box/select and shows it. */ /** Creates a new dual list box with the right buttons and filter. */ /** Creates the buttons when the dual list box is set in horizontal mode. */ /** Creates the buttons when the dual list box is set in vertical mode. */ /** Specifically handles the movement when one or more elements are moved. */ /** Parses the stub select / list box that is first created. */ /** Toggles the buttons based on the length of the selects. */ /**
